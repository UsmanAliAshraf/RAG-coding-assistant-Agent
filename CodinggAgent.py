...
llm = ChatGoogleGenerativeAI(
    ...
    temperature=0,
    google_api_key="AIzaSyCNf6Xf1ZB8zQaNKUbTT_z7gy4NfsV63r0"  # 👈 force API key usage
)
...
# ✅ Agent is ready
print("🤖 Python Agent with REPL Tool is ready!")
